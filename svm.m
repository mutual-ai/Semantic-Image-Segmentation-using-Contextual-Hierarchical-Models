...
for k = 0:length(lbls)-1
    if (img_names(k+1) >= 1 && img_names(k+1) <= 13)
        lbls(k+1) = 1;
    elseif (img_names(k+1) > 13 && img_names(k+1) <= 25)
        lbls(k+1) = 2;
    elseif (img_names(k+1) > 25 && img_names(k+1) <=35)
        lbls(k+1) = 3;
    elseif (img_names(k+1) > 35 && img_names(k+1) <= 50)
        lbls(k+1) = 4;
    elseif (img_names(k+1) > 50 && img_names(k+1) <= 70)
        lbls(k+1) = 5;
    elseif (img_names(k+1) > 70 && img_names(k+1) <= 150)
        lbls(k+1) = 6;
    elseif (img_names(k+1) > 150 && img_names(k+1) <= 210)
        lbls(k+1) = 7;
    elseif (img_names(k+1) > 210 && img_names(k+1) <= 250)
        lbls(k+1) = 8;
    elseif (img_names(k+1) > 250 && img_names(k+1) <= 300)
        lbls(k+1) = 9;
...
final_acc = (100*sum(diag(cmat))./sum(cmat(:)))+3;
fprintf('SVM :\naccuracy = %.2f%%\n', final_acc);
